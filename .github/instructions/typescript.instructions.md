...
const applyDiscount = (total: number, discount: number): number => total * (1 - discount);
...
const processOrder = pipe(validateOrder, calculateTax, applyDiscount, formatForDisplay);
